...
(d) the recording is an exempt recording; and
(e) the copy is not an exempt recording and the person is negligent as to that fact. Penalty: 120 penalty units or imprisonment for 2 years, or both.
...
(c) the copy is made without the authority of the performer; and
(d) the recording is an exempt recording; and
(e) the copy is not an exempt recording. Penalty: 60 penalty units.
