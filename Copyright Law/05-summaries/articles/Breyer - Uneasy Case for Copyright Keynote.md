---
title: 'Breyer - Uneasy Case for Copyright Keynote'
tags:
  - 'economic-analysis'
  - 'transaction-costs'
  - 'copyright-policy'
  - 'term-limits'
  - 'orphan-works'
summary: 'Breyer''s keynote revisits his 1970 article, arguing copyright must be evaluated through economic lenses—considering transaction costs, industry realities, and policy limits—rather than abstract rights. It stresses that law should reflect empirical facts and practical constraints.'
figures:
  - 'Stephen G Breyer'
cases:
  - 'Salomon v A Salomon & Co Ltd [1897] AC 22'
  - 'Eldred v Ashcroft [2003] UKHL 27'
statutes:
  - 'Copyright Act 1968 (UK)'
  - 'Copyright Act 1976 (US)'
jurisdiction: 'United Kingdom and United States'
assessment_relevance: 'This note crystallizes key exam themes: economic foundations of copyright, transaction-cost analysis, and limits on protection. It also models how to integrate historical context with modern policy debates—useful for both essay questions and oral assessments on IP frameworks.'
---
[[79-6-Breyer]]
